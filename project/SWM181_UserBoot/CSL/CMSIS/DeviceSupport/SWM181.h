...
#define UART_CTRL2_INV_Pos			0		//收发数据线上电平取反
#define UART_CTRL2_INV_Msk			(0x01 << UART_CTRL2_INV_Pos)
#define UART_CTRL2_MSBF_Pos			1		//MSB First
#define UART_CTRL2_MSBF_Msk			(0x01 << UART_CTRL2_MSBF_Pos)
